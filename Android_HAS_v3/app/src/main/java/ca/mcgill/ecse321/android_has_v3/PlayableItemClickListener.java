...
public class PlayableItemClickListener implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(parent.getContext(), SendPlayableActivity.class);
        SendPlayableActivity.setSelectedPlayable((Playable) parent.getAdapter().getItem(position));
